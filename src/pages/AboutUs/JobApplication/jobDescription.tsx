...
const JobDescription = (): React.JSX.Element => (
  <section className="job-description">
    ...
    <p>
      ...
      training they need! Cleaning experience is desired but not required at our
      company. If you love cleaning and enjoy helping others - this is a job for
      you! We'll ensure you get the training you need to become a cleaning
      professional.
    </p>
    <h3>Requirements:</h3>
    <ul>
      <li>At least two years of paid professional cleaning experience</li>
    ...
    <ul>
      ...
      <li>Own working vehicle</li>
      <li>Contractors must have their own cleaning supplies</li>
      <li>
        Contractors must have or be willing to purchase Professional General
        Liability Insurance
      </li>
    </ul>
    <h3>We offer:</h3>
    <ul>
      ...
      <li>Bonuses for five-star reviews</li>
      <li>Stable regular clients</li>
      <li>Bonuses for referring other cleaners</li>
      <li>No need to pay for cleaning materials</li>
